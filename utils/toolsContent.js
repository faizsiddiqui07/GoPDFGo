// Long-form page content for every tool: intro, walkthrough,
// features, use cases, steps and FAQs.
//
// Deliberately separate from constants.js. This is ~260KB of prose that
// only ever renders on the server (page.jsx -> InfoSection). Keeping it in
// TOOLS_CONFIG meant every client component that imported that file — the
// header on every page included — pulled all of it into the browser bundle.
// Import this ONLY from server components, or pass a single tool's slice
// down as a prop.
...
export const TOOL_INFO = {
  ...
  "extract-pdf-pages": {
    ...
    "walkthrough": {
      "heading": "Pulling your page out of a 500-page merit list",
      "troubleshootingHeading": "Did the wrong page come out?",
  ...
  "split-pdf": {
    ...
    "walkthrough": {
      "heading": "Emailing a report that is over the limit",
      "troubleshootingHeading": "Got a ZIP when you wanted a PDF",
  ...
  "rotate-pdf": {
    ...
    "walkthrough": {
      "heading": "Fixing a scan that opens sideways",
      "troubleshootingHeading": "Rotation that won't come out straight",
  ...
  "image-to-pdf": {
    ...
    "walkthrough": {
      "heading": "Turning phone photos into one PDF",
      "troubleshootingHeading": "Photos out of order or sideways",
  ...
  "rearrange-pdf": {
    ...
    "walkthrough": {
      "heading": "Moving a summary to the front",
      "troubleshootingHeading": "Reordered, but the export looks the same?",
  ...
  "pdf-to-image": {
    ...
    "walkthrough": {
      "heading": "Pulling one page out of a PDF as a JPG",
      "troubleshootingHeading": "One page, one JPG, not a ZIP",
  ...
  "watermark-pdf": {
    ...
    "walkthrough": {
      "heading": "Stamping an ID copy before you send it",
      "troubleshootingHeading": "When the watermark hides the words beneath it",
  ...
  "delete-pdf-pages": {
    ...
    "walkthrough": {
      "heading": "Cutting the blank page a scanner adds",
      "troubleshootingHeading": "Brought back a page you cut by accident?",
  ...
  "unlock-pdf": {
    ...
    "walkthrough": {
      "heading": "A bank statement a KYC portal keeps rejecting",
      "troubleshootingHeading": "Unlocked, but the portal still says no",
  ...
  "ocr-pdf": {
    ...
    "walkthrough": {
      "heading": "Getting the text off a bilingual government form",
      "troubleshootingHeading": "When Hindi comes back as gibberish",
  ...
  "pdf-to-text": {
    ...
    "walkthrough": {
      "heading": "Pulling a clause out of an agreement",
      "troubleshootingHeading": "Text that came back scrambled or empty",
  ...
  "organize-pdf": {
    ...
    "walkthrough": {
      "heading": "Fixing a messy scan in one pass",
      "troubleshootingHeading": "Pages sorted but the scan text won't select",
  ...
  "sign-pdf": {
    ...
    "walkthrough": {
      "heading": "Signing a rental agreement",
      "troubleshootingHeading": "That white box around your signature",
  ...
  "compress-jpg": {
    ...
    "walkthrough": {
      "heading": "A 2 MB photo down under 1 MB",
      "troubleshootingHeading": "Squeezed the photo and lost the sharpness",
  ...
  "compress-jpeg": {
    ...
    "walkthrough": {
      "heading": "Getting a phone photo under 50 KB",
      "troubleshootingHeading": "Can't get the JPEG down to 20 KB?",
  ...
  "compress-webp": {
    ...
    "walkthrough": {
      "heading": "Slimming a hero image for PageSpeed",
      "troubleshootingHeading": "When the WebP barely shrinks or turns soft",
  ...
  "compress-png": {
    ...
    "walkthrough": {
      "heading": "A heavy screenshot cut down to a fraction of its size",
      "troubleshootingHeading": "PNG still too big, or looking banded?",
  ...
  "resize": {
    ...
    "walkthrough": {
      "heading": "A phone photo into a 400x400 profile picture",
      "troubleshootingHeading": "When a resized photo stretches or turns white",
  ...
  "combine-images": {
    ...
    "intro": "Plenty of forms ask for something that sounds simple and turns out to be annoying: **both sides of your ID in a single file**. You photograph the front, you photograph the back, and now you have two pictures and one upload box that will only take one.\n\nOn a laptop people open an image editor and fight with it. On a phone, which is where most of this actually happens, there is usually no good answer at all — so people end up sending two files and hoping, or pasting them into a document and screenshotting that.\n\nGoPDFGo's **Combine Images** tool does exactly the one job: you add your photos, drag each one where you want it on an A4 page, resize it to fit, and download a single image with both of them on it. It runs inside your browser, so an Aadhaar card, a cheque or a salary slip is never uploaded to anyone's server — which matters, because these are exactly the documents people are asked to combine.",
    "walkthrough": {
      "heading": "Front and back of an ID in one file",
      "troubleshootingHeading": "Mismatched sizes, sideways results, white backgrounds",
      "body": "Photograph both sides of the card and add them. Each one lands on a blank A4 page as a movable box. Drag the front photo to the top of the page and the back below it — or wherever you want them. There is no fixed layout here, so you decide exactly what the finished sheet looks like.\n\nResize each photo on its own by dragging the small orange handle at its bottom-right corner. The photo always keeps its proportions, so nothing is ever stretched — you are only making it bigger or smaller on the page. Make the front and back roughly the same width if you want them to read as a matched pair, or leave one larger if that suits the document better.\n\nPick the page shape to match your photos. **Portrait** is a tall A4 and suits ID cards placed one above the other; **Landscape** is a wide A4 and fits two tall photos sitting side by side. The whole page is plain white, like a sheet of paper, so the result looks like a proper scan rather than a collage.\n\nThen save it: **JPG** for the smallest file, which is what most upload forms want, or **PNG** when the photos contain small printed text you want kept as crisp as possible. Once you have the page, [black out the number before you share it](/aadhaar-masking) if this is an ID copy, [shrink it](/compress-jpg) if the portal has a size cap, or [turn it into a PDF](/image-to-pdf) if the form asks for one instead of an image.",
      "troubleshooting": [
        {
          "problem": "One photo looks much bigger than the other",
          "fix": "You choose the size here, so this is easy to fix. Tap the photo and drag the orange corner handle to make it smaller or larger until the two match. Nothing is resized automatically — whatever size you leave a photo at is exactly what the page will show."
        },
        {
        ...
        },
        {
          ...
          "fix": "The page is a sheet of white paper on purpose, so the space around your photos is always white — in both JPG and PNG. If you want a photo with no page around it, use the Crop tool on that photo instead of this one."
        },
        {
          "problem": "The file is too big for the upload form",
          "fix": "The page is saved at a fixed A4 size, so it can be heavier than a single phone photo. Save as JPG rather than PNG, then run it through Compress JPG and set the exact KB limit the form asks for."
        }
      ]
    },
    "features": [
      {
        ...
        "desc": "Most tools that join images are general-purpose collage makers buried in options. This one is shaped around the request Indian forms actually make — **both sides of an ID on one page** — so you add your photos, drag them into place, and download, with nothing else in the way."
      },
      {
      ...
      },
      {
        ...
        "desc": "You resize each photo by hand, and it always keeps its proportions — dragging the corner makes it bigger or smaller, never squashed or stretched. Your card looks like your card, at whatever size you place it on the page."
      }
    ],
    "useCases": [
      ...
      "**Screenshots Split Across Two Shots:** A long chat, a bill or a bank statement that would not fit in one screen — place the shots on one page instead of sending several.",
      "**Before and After Photos:** Sellers, tailors and repair shops placing two pictures on one page to show a comparison in a single WhatsApp message."
    ],
    "steps": [
      "**Add your photos:** Drop in two or more images, or tap to pick them from your phone. They stay on your device.",
      "**Arrange them on the page:** Drag each photo where you want it and resize it from the orange corner handle. There is no fixed layout — you decide.",
      "**Pick the page shape:** Portrait for ID cards placed one above the other, or Landscape for tall photos sitting side by side.",
    ...
    "faq": [
      {
        ...
        "a": "Add both photos, drag the front to the top of the page and the back below it, resize each so they sit neatly, and download. That gives you one image with both sides, which is what a single upload box needs. Before you send it anywhere, consider masking the first 8 digits with our **Aadhaar & ID Masking** tool — and cover the QR code too, since it carries the same details."
      },
      {
        "q": "Can I combine more than two photos?",
        "a": "Yes. Add as many as you need and arrange them all on the same page. Bear in mind that a crowded page gets cramped, and fitting several photos on one sheet often reads better in Landscape."
      },
      {
      ...
      },
      {
        ...
        "a": "Only as much as the size you choose. A photo shown smaller than its original stays sharp; blown up much larger than it was taken, it can soften. Saving as PNG keeps the page lossless; saving as JPG re-compresses it slightly to produce a smaller file, which is usually invisible for a document photo."
      },
      {
  ...
  "crop": {
    ...
    "walkthrough": {
      "heading": "Cropping a selfie into a square profile picture",
      "troubleshootingHeading": "Crop won't lock square, or trimmed too far?",
  ...
  "convert-webp": {
    ...
    "walkthrough": {
      "heading": "A transparent logo and a batch of photos",
      "troubleshootingHeading": "WebP came out blocky or even bigger",
  ...
  "convert-jpg": {
    ...
    "walkthrough": {
      "heading": "A PNG a portal keeps rejecting",
      "troubleshootingHeading": "Lost transparency, or a HEIC that won't select",
  ...
  "convert-png": {
    ...
    "walkthrough": {
      "heading": "Turning a WebP logo into a clean PNG",
      "troubleshootingHeading": "Why is my PNG bigger or still blurry?",
  ...
  "heic-to-jpg": {
    ...
    "walkthrough": {
      "heading": "Getting an iPhone photo onto a job portal",
      "troubleshootingHeading": "Blank photos, or a stubborn .heif file",
  ...
  "heic-to-png": {
    ...
    "walkthrough": {
      "heading": "Prepping an iPhone photo to edit",
      "troubleshootingHeading": "Why the PNG ends up bigger than the HEIC",
  ...
  "heic-to-webp": {
    ...
    "walkthrough": {
      "heading": "Putting iPhone photos on a blog",
      "troubleshootingHeading": "When a form or old app rejects the WebP",
  ...
  "rotate": {
    ...
    "walkthrough": {
      "heading": "A photo that keeps reverting sideways",
      "troubleshootingHeading": "Upright on your phone, sideways on the web",
  ...
  "flip": {
    ...
    "walkthrough": {
      "heading": "Making backwards text readable",
      "troubleshootingHeading": "Text still reads backwards after flipping?",
  ...
  "color-picker": {
    ...
    "walkthrough": {
      "heading": "Matching a button to your logo blue",
      "troubleshootingHeading": "The picked colour lands a shade off",
  ...
  "aadhaar-masking": {
    ...
    "walkthrough": {
      "heading": "Masking an Aadhaar for a SIM form",
      "troubleshootingHeading": "A digit still peeking past the black box",
  ...
  "qr-generator": {
    ...
    "walkthrough": {
      "heading": "A Wi-Fi sign for the reception desk",
      "troubleshootingHeading": "If the printed code refuses to scan",
